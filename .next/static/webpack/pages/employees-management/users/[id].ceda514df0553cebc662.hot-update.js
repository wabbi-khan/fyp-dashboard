                ...
                try {
                  ...
                  Object(firebase_firestore__WEBPACK_IMPORTED_MODULE_10__["getDocs"])(employeeInstance, user).then(function (data) {
                    for (var i = 0; i < data.docs.length; i++) {
                      ...
                      setUser(item.id); // console.log(item.data());
                    }
