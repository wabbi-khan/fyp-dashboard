          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                try {
                  employees = [];
                  data = Object(firebase_firestore__WEBPACK_IMPORTED_MODULE_10__["getDocs"])(employeeInstance).then(function () {
